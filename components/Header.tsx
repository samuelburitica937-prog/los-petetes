        ...
        >
            ...
            >
                {[
                    ...
                    { href: '/categoria/petshop', label: '🐾 Pet' },
                    { href: '/categoria/deportes', label: '⚡ Deporte' },
                    { href: '/categoria/bebes', label: '🍼 Bebés' },
                    { href: '/categoria/sexshop', label: '❤️ Íntimo' },
                    { href: '/categoria/electrodomesticos', label: '📺 Electro' },
                    { href: '/categoria/tecnologia', label: '📱 Tec' },
                    { href: '/categoria/papeleria', label: '📝 Papel' },
                    { href: '/categoria/escolar', label: '🎒 Escolar' },
                    { href: '/categoria/oficina', label: '💼 Ofi' },
                    { href: '/categoria/horaloca', label: '🥳 H. Loca' },
                    { href: '/categoria/jugueteria', label: '🧸 Juguete' },
                ].map(({ href, label }) => (
                    <Link
                        key={href}
                        href={href}
            ...
            {menuOpen && (
                ...
                >
                    ...
                    {[
                        ...
                        { href: '/categoria/salud', label: '💊 Salud' },
                        { href: '/categoria/hogar', label: '🏠 Hogar' },
                        { href: '/categoria/petshop', label: '🐾 Pet Shop' },
                        { href: '/categoria/deportes', label: '⚡ Deportes' },
                        { href: '/categoria/bebes', label: '🍼 Bebés' },
                        { href: '/categoria/sexshop', label: '❤️ Íntimos' },
                        { href: '/categoria/electrodomesticos', label: '📺 Electrodomésticos' },
                        { href: '/categoria/tecnologia', label: '📱 Tecnología' },
                        { href: '/categoria/papeleria', label: '📝 Papelería' },
                        { href: '/categoria/escolar', label: '🎒 Escolar' },
                        { href: '/categoria/oficina', label: '💼 Oficina' },
                        { href: '/categoria/horaloca', label: '🥳 Hora Loca' },
                        { href: '/categoria/jugueteria', label: '🧸 Juguetería' },
